...
def run_blender_import(json_path):
    ...
    if site_bsdf:
        site_bsdf.inputs['Base Color'].default_value = (1.0, 0.7, 0.0, 1.0)  # Amber Gold
    ...
    if bldg_bsdf:
        bldg_bsdf.inputs['Base Color'].default_value = (0.7, 0.75, 0.8, 1.0) # Architectural Blue-Grey

    # 2. Build Testing Site Mesh
