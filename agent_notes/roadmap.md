...
* **Status**: `[COMPLETE 26-08-26]` — `main` fast-forwarded `0b04ad35..b20be003` (38 commits), user-approved. `main` now = v0.9.0: suite 170 OK (skipped=2), branding v0.9.0, stable default LR 0.001.
* **Steps**:
  ...
  5. **Merge**: Fast-forward `main` to the `v0.9.0` state (main sits at the merge-base, so the merge is zero-conflict). `[DONE 26-08-26]` — pushed `version/v0.9.0-alpha:main` → `0b04ad35..b20be003`, user-approved.
