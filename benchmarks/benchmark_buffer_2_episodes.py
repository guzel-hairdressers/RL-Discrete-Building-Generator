#!/usr/bin/env python3
"""500-Episode Benchmark: Buffer = 2 Episodes with SE(2) Spatial Critic + PBRS.
...
def main():
    print("=" * 80)
    print("STARTING 500-EPISODE BENCHMARK: BUFFER = 2 EPISODES (Seed=42)")
    print("=" * 80)
    ...
    for ep in range(1, num_episodes + 1):
        ...
        if ep % 50 == 0 or ep in (1, 10, 20):
            ...
            print(
                f"[Buffer=2 Ep] Ep {ep:3d}/500: Last50 Score={avg:6.2f} pts | "
    ...
    out_file = "benchmarks/convergence_buffer_2_episodes_500.json"
