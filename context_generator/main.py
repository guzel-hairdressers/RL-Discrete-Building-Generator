...
from exporter import export_context_to_json
...
def handle_extract(args):
    ...
    for c_key in cities_to_extract:
        extract_city_osmnx_3d(c_key, radius_m=args.radius, force_download=args.force)

    print("\n[Done] OSM extraction complete!")
...
def main():
    ...
    extract_parser.add_argument("--radius", type=float, default=100.0, help="Context radius in meters (default 100.0 = 200m x 200m)")
    extract_parser.add_argument("--force", action="store_true", help="Force fresh download from OpenStreetMap API")
    ...
    gen_parser.add_argument("--radius", type=float, default=100.0, help="Context radius in meters (default 100.0 = 200m x 200m)")
