...
export const ThreeViewer = () => {
  ...
  const optimizerGroupRef = useRef(new THREE.Group());
  ...
  }, [individualPlacementsList, currentMergedPlacements, disableMerging, boundaries, activeSiteIndex]);
  ...
  return (
    <div className="left-3d-pane">
      ...
      {/* Floating UI Elements matching Context Generator exact positions */}
      <FilterBar />
      <SiteInfoCard />
      <ViewToggle />
      <CarouselNav />
