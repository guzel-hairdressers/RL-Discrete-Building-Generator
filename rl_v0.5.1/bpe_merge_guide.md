...
* **Objective**: Raw triangles and tiny shapes create sharp, unusable angles and are heavily penalized in the reward structure (generating severe penalties of `-1.5` to `-8.0` points per triangle).
